...
This area holds the UiPath **Dispatcher + REFramework Performer** for the Clinical
Referral Safety Automation, plus the design contract they are built from.
...
Phase 8 is orchestration only — no new business logic. Start from
